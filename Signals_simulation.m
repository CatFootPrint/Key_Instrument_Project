...
%ѡ���ŵ�����
    channel_select=menu('Type of noise in channel','AWGN','Rayleigh','Rician');
...
signal_send_transmitter=Windows_send(signal,100);%���Ͷ˾������ϲ������ź�
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%�����ŵ�%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
signal_send_channel=channel_function(signal_send_transmitter,channel_type);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%�����ź�%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
signal_receive=Windows_receive(signal_send_channel,100);%���ն˾������²������ź�
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%��ͼ%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%��1��ͼ�������˴������ϲ�����ź�
...
figure(3);
%output=kernel_2D(signal_receive);
syms x;
input=signal_receive;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
input=reshape(input,numel(input),1);%ת��������ݣ�ʹ������ݱ��������
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
distance=distance_matrix(input);%��ɾ������
average_distance=mean(mean(distance))*(1-1/numel(input));
% kernel_matrix=exp(-distance.^2/2/average_distance);
kernel_matrix=exp(-(x-input).*conj(x-input)/2/average_distance);
ratio=((kernel_matrix))/(sum(kernel_matrix));
output=ones(1,numel(input))*(ratio.*input);
ezmesh(meshgrid(numel(output),numel(output)),real(output),imag(output));
grid on;

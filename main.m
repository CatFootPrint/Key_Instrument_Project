...
% filename_record=['counter_8_','record_lambda_',num2str(lambda1),'_size_',num2str(numel(signal)),'_snr',num2str(SNR),'.mat'];
...
label=repmat(1:size(signal_type,2),1,size(label_ksvd,2)/size(signal_type,2));
...
% between_modulation(label,label_ksvd,label_ksvd,label_ksvd);